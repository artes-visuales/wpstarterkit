...
La plantilla de comentarios es una página compleja de realizar. Confusa.

**No obstante de un vistazo rápido esta plantilla realiza:**
- Evita la carga de los robots en los mensajes que están protegidos por contraseña.
- Comprueba si hay comentarios.
- Cuenta el número de comentarios y vínculos de referencia  trackbacks (or pings)
- Si no hay observaciones se muestran los comentarios paginados.
- Muestra los trackbacks
- Si los comentarios están abiertos se muestran de modo que se puedan responder.
- Callbacks personalizados para Comments y Trackbacks

Comenzamos añadiendo 2 funciones en el archivo functions.php del tema. La finalidad de los mismos es que nos devuelva unas llamadas personalizadas para la lista de comentarios y trackbacks.
...
Añadimos una función especial más para personalizar los comentarios de acuerdo con Gravatar.
...
Si queremos cambiar el tamaño por defecto del avatar hay que cambiar el valor ( $avatar\_email, 80 ) ); . 80 es el tamaño en píxeles de su Gravatar.

### La plantilla de comments ###

Aquí te escribo el código de la plantilla de comentarios, como ves está comentada para que puedas ir comprendiendo las partes que la componen.

```
<?php /* La plantilla Comments  — con comentarios! */ ?> 
 
<div id="comments">
	<?php /* Chequea los post protegidos con password */ ?>    
	<?php
...
?>
 
<?php /* Ver si hay comentarios */ ?>                                             
<?php if ( have_comments() ) : ?>
 
<?php /* Contar el número de comentarios y trackbacks (o pings) */
$ping_count = $comment_count = 0;
foreach ( $comments as $comment )
    get_comment_type() == "comment" ? ++$comment_count : ++$ping_count;
?>
 
<?php /* Si hay comentarios se muestran */ ?>
...
 
<?php /* Si hay suficientes comentarios crear la navegación de contenidos */ ?>                                      
...
<?php endif; ?>                                 
 
<?php /* Una lista ordenada de nuestros comments callback, custom_comments(), en functions.php   */ ?>                           
	<ol>
	<?php wp_list_comments('type=comment&callback=custom_comments'); ?>
	</ol>
 
<?php /* Si hay suficientes comentarios, crear la navegación de comentarios */ ?>
<?php $total_pages = get_comment_pages_count(); if ( $total_pages > 1 ) : ?>                                    
...
 
<?php /* Si hay trackbacks(pings), mostra los trackbacks  */ ?>
...
 
<?php /* Y ordenar en listas los trackbacks callback, custom_pings(), in functions.php   */ ?>                                    
	<ol>
...
 
<?php /* Si los comentarios están abiertos mostrar el formulario de respuesta */ ?>
<?php if ( 'open' == $post->comment_status ) : ?>
 
<div id="respond">
	<h3><?php comment_form_title( __('Escriba su comentario', 'your-theme'), __('Post a Reply to %s', 'your-theme') ); ?></h3>
 
